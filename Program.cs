...
namespace atividadeAv
{
    public class Program
    {
        ...
        public static void RunMenuTeste(Academia academia)
        {
            string choice;
            do
            {
            ...
            public static void RunMenu(Academia academia)
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("2. Menu de Relatórios");
                    Console.WriteLine("3. Menu de Testes");
                    ...
                    try
                    {
                        switch (choice)
                        {
                            ...
                            case "1":
                                ...
                                academia.AdicionaAlgunsPagamentos();
